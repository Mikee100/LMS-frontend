...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true);
    try {
      const response = await fetch('https://lms-backend-4b82.onrender.com/api/auth/login', {
        method: 'POST',
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    try {
      const response = await fetch('https://lms-backend-4b82.onrender.com/api/auth/google-login', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
